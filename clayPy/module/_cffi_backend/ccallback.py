...
from clayPy.module._cffi_backend import cerrno, misc, parse_c_type
from clayPy.module._cffi_backend.cdataobj import W_CData
from clayPy.module._cffi_backend.ctypefunc import SIZE_OF_FFI_ARG, W_CTypeFunc
from clayPy.module._cffi_backend.ctypeprim import W_CTypePrimitiveSigned
from clayPy.module._cffi_backend.ctypevoid import W_CTypeVoid
from clayPy.module._cffi_backend.hide_reveal import hide_reveal1
...
class W_ExternPython(W_CData):
    ...
    def __init__(self, space, cdata, ctype, w_callable, w_error, w_onerror):
        ...
        if space.config.translation.thread:
            from clayPy.module.thread.os_thread import setup_threads
            setup_threads(space)
    ...
    def handle_applevel_exception(self, e, ll_res, extra_line):
        from clayPy.module._cffi_backend import errorbox
        space = self.space
        self.write_error_return_value(ll_res)
