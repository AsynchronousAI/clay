...
from clayPy.module._cffi_backend import cdataobj, misc, ctypeprim, ctypevoid
...
class W_CTypePtrOrArray(W_CType):
    ...
    def convert_array_from_object(self, cdata, w_ob):
        ...
        if (space.isinstance_w(w_ob, space.w_list) or
            ...
            from clayPy.module._cffi_backend import wchar_helper
...
class W_CTypePointer(W_CTypePtrBase):
    ...
    def convert_argument_from_object(self, cdata, w_ob, keepalives, i):
        ...
        from clayPy.module._cffi_backend.ctypefunc import set_mustfree_flag
