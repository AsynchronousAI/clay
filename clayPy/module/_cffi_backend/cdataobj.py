...
from clayPy.interpreter.gateway import interp2app
from clayPy.interpreter.typedef import TypeDef, make_weakref_descr
...
from clayPy.module._cffi_backend import misc
...
class W_CData(W_Root):
    ...
    def __init__(self, space, ptr, ctype):
        from clayPy.module._cffi_backend import ctypeobj
    ...
    def _repr_extra_owning(self):
        from clayPy.module._cffi_backend.ctypeptr import W_CTypePointer
        ctype = self.ctype
    ...
    def repr(self):
        ...
        if not isinstance(self, W_CDataNewOwning):
            ...
            from clayPy.module._cffi_backend import ctypestruct
    ...
    def len(self):
        from clayPy.module._cffi_backend import ctypearray
        space = self.space
    ...
    def _compare_mode(self, w_other):
        from clayPy.module._cffi_backend.ctypeprim import W_CTypePrimitive
    ...
    def _do_getslice(self, w_slice):
        ...
        if ctarray is None:
            from clayPy.module._cffi_backend import newtype
    ...
    def _do_setslice(self, w_slice, w_value, ptr):
        ...
        from clayPy.module._cffi_backend import ctypeprim
        space = self.space
    ...
    def sub(self, w_other):
        space = self.space
        if isinstance(w_other, W_CData):
            from clayPy.module._cffi_backend import ctypeptr, ctypearray
            ct = w_other.ctype
    ...
    def unpack(self, length):
        from clayPy.module._cffi_backend.ctypeptr import W_CTypePtrOrArray
        space = self.space
