...
from clayPy.interpreter.gateway import interp2app, interpindirect2app
from clayPy.interpreter.typedef import TypeDef
from clayPy.objspace.std.iterobject import W_AbstractSeqIterObject

from clayPy.module._rawffi.interp_array import W_ArrayInstance
from clayPy.module._cffi_backend import ctypefunc, cdataobj, misc
from clayPy.module._cffi_backend import newtype
from clayPy.module._cppyy import ffitypes
from clayPy.module.sys.version import PYPY_VERSION

from clayPy.module._cppyy.capi.capi_types import C_SCOPE, C_TYPE, C_OBJECT,\
...
def load_backend(space):
    ...
    if state.backend is None:
        from clayPy.module._cffi_backend.libraryobj import W_Library
...
class W_STLVectorIter(W_AbstractSeqIterObject):
    ...
    def __init__(self, space, w_vector):
        ...
        from clayPy.module._cppyy import converter
