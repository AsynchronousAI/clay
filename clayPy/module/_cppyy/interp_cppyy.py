import clayPy.module._cppyy.capi as capi

from clayPy.interpreter.error import OperationError, oefmt
from clayPy.interpreter.function import Method
from clayPy.interpreter.argument import Arguments
from clayPy.interpreter.typedef import interp_attrproperty_w, descr_generic_ne, make_weakref_descr
...
from clayPy.module._cffi_backend import ctypefunc
from clayPy.module._cppyy import converter, executor, ffitypes, helper
...
def get_nullptr(space):
    ...
    if state.w_nullptr is None:
        from clayPy.module._rawffi.interp_rawffi import unpack_simple_shape
        from clayPy.module._rawffi.interp_array import W_Array, W_ArrayInstance
