...
from clayPy.module._rawffi.interp_rawffi import letter2tp
from clayPy.module._rawffi.interp_array import W_ArrayInstance
from clayPy.module._cppyy import helper, capi, ffitypes, lowlevelviews
...
def get_rawobject(space, w_obj, can_be_None=True):
    from clayPy.module._cppyy.interp_cppyy import W_CPPInstance
...
def is_nullpointer_specialcase(space, w_obj):
    ...
    try:
        ...
        pass
    # C++-style nullptr
    from clayPy.module._cppyy import interp_cppyy
...
class TypeConverter(object):
    ...
    def cffi_type(self, space):
        from clayPy.module._cppyy.interp_cppyy import FastCallNotPossible
...
class InstanceRefConverter(TypeConverter):
    ...
    def __init__(self, space, clsdecl):
        from clayPy.module._cppyy.interp_cppyy import W_CPPClassDecl
    ...
    def _unwrap_object(self, space, w_obj):
        ...
        if isinstance(w_obj, W_CPPInstance):
            from clayPy.module._cppyy.interp_cppyy import INSTANCE_FLAGS_IS_RVALUE
...
class InstanceMoveConverter(InstanceRefConverter):
    def _unwrap_object(self, space, w_obj):
        ...
        from clayPy.module._cppyy.interp_cppyy import W_CPPInstance, INSTANCE_FLAGS_IS_RVALUE
...
class InstancePtrConverter(InstanceRefConverter):
    ...
    def to_memory(self, space, w_obj, w_value, offset):
        ...
        if cppinstance:
            ...
            from clayPy.module._cppyy.interp_cppyy import memory_regulator
...
class PyObjectConverter(TypeConverter):
    ...
    def convert_argument(self, space, w_obj, address):
        ...
        from clayPy.module.cpyext.pyobject import make_ref
    ...
    def free_argument(self, space, arg):
        if hasattr(space, "fake"):
            raise NotImplementedError
        space.getbuiltinmodule("cpyext")
        from clayPy.module.cpyext.pyobject import decref, PyObject
...
class FunctionPointerConverter(TypeConverter):
    ...
    def convert_argument(self, space, w_obj, address):
        ...
        from clayPy.module._cppyy.interp_cppyy import W_CPPOverload
...
class SmartPtrConverter(TypeConverter):
    ...
    def __init__(self, space, smartdecl, raw, deref):
        from clayPy.module._cppyy.interp_cppyy import W_CPPClassDecl, get_pythonized_cppclass
