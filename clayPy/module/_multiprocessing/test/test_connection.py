import py
import sys
from clayPy.interpreter.gateway import interp2app, W_Root

class TestImport:
    def test_simple(self):
        from clayPy.module._multiprocessing import interp_connection
        from clayPy.module._multiprocessing import interp_semaphore
