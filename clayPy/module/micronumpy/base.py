...
class W_NDimArray(W_NumpyObject):
    ...
    def __init__(self, implementation):
        from clayPy.module.micronumpy.concrete import BaseConcreteArray
    ...
    def from_shape(space, shape, dtype, order=NPY.CORDER,
        ...
        from clayPy.module.micronumpy import concrete, descriptor, boxes
    ...
    def from_shape_and_storage(space, shape, storage, dtype, storage_bytes=-1,
                               ...
                               start=0):
        from clayPy.module.micronumpy import concrete
        from clayPy.module.micronumpy.strides import (calc_strides,
                                                    calc_backstrides)
        isize = dtype.elsize
        if len(shape) > NPY.MAXDIMS:
