...
from clayPy.interpreter.gateway import interp2app, unwrap_spec, applevel, \
    WrappedDefault
from clayPy.interpreter.typedef import TypeDef, GetSetProperty, \
    make_weakref_descr
from clayPy.interpreter.buffer import SimpleView
...
from clayPy.module.micronumpy import descriptor, ufuncs, boxes, arrayops, loop, \
    support, constants as NPY
from clayPy.module.micronumpy.appbridge import get_appbridge_cache
from clayPy.module.micronumpy.arrayops import repeat, choose, put
from clayPy.module.micronumpy.base import W_NDimArray, convert_to_array, \
    ArrayArgumentException, wrap_impl
from clayPy.module.micronumpy.concrete import BaseConcreteArray, V_OBJECTSTORE
from clayPy.module.micronumpy.converters import (
...
from clayPy.module.micronumpy.strides import (
    ...
    SliceChunk)
from clayPy.module.micronumpy.casting import can_cast_array
...
class __extend__(W_NDimArray):
    ...
    def descr_reduce(self, space):
        ...
        from clayPy.module.micronumpy.concrete import SliceArray
...
def descr_new_array(space, w_subtype, w_shape, w_dtype=None, w_buffer=None,
    ...
    from clayPy.module.micronumpy.concrete import ConcreteArray
    dtype = space.interp_w(descriptor.W_Dtype, space.call_function(
        space.gettypefor(descriptor.W_Dtype), w_dtype))
