...
from clayPy.conftest import option
from clayPy.module.micronumpy.appbridge import get_appbridge_cache
from clayPy.module.micronumpy.strides import Chunk, new_view, EllipsisChunk
from clayPy.module.micronumpy.ndarray import W_NDimArray
import clayPy.module.micronumpy.constants as NPY
from clayPy.module.micronumpy.test.test_base import BaseNumpyAppTest
...
class TestNumArrayDirect(object):
    ...
    def test_shape_agreement(self):
        from clayPy.module.micronumpy.strides import _shape_agreement
    ...
    def test_calc_new_strides(self):
        from clayPy.module.micronumpy.strides import calc_new_strides
    ...
    def test_find_shape(self):
        from clayPy.module.micronumpy.ctors import find_shape_and_elems
