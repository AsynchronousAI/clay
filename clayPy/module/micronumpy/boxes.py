...
from clayPy.interpreter.gateway import interp2app, unwrap_spec
from clayPy.interpreter.mixedmodule import MixedModule
from clayPy.interpreter.typedef import TypeDef, GetSetProperty
...
from clayPy.objspace.std.intobject import W_IntObject
...
from clayPy.module.micronumpy import constants as NPY
from clayPy.module.micronumpy.base import W_NDimArray, W_NumpyObject
from clayPy.module.micronumpy.concrete import VoidBoxStorage
from clayPy.module.micronumpy.flagsobj import W_FlagsObject
from clayPy.module.micronumpy import support
...
def new_dtype_getter(num):
    ...
    def _get_dtype(space):
        from clayPy.module.micronumpy.descriptor import num2dtype
        return num2dtype(space, num)

    def descr__new__(space, w_subtype, w_value=None):
        from clayPy.module.micronumpy.ctors import array
...
class W_GenericBox(W_NumpyObject):
    ...
    def descr_getitem(self, space, w_item):
        from clayPy.module.micronumpy.base import convert_to_array
    ...
    def _unaryop_impl(ufunc_name):
        def impl(self, space, w_out=None):
            from clayPy.module.micronumpy import ufuncs
    ...
    def descr_any(self, space):
        from clayPy.module.micronumpy.descriptor import get_dtype_cache
    ...
    def descr_astype(self, space, w_dtype):
        from clayPy.module.micronumpy.descriptor import W_Dtype
...
class W_VoidBox(W_FlexibleBox):
    def descr_getitem(self, space, w_item):
        ...
        from clayPy.module.micronumpy.types import VoidType
...
class W_StringBox(W_CharacterBox):
    def descr__new__string_box(space, w_subtype, w_arg):
        from clayPy.module.micronumpy.descriptor import new_string_dtype
...
class W_UnicodeBox(W_CharacterBox):
    ...
    def get_dtype(self, space):
        from clayPy.module.micronumpy.descriptor import new_unicode_dtype
