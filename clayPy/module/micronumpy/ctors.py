...
from clayPy.interpreter.baseobjspace import BufferInterfaceNotFound
from clayPy.interpreter.gateway import unwrap_spec, WrappedDefault
from rpython.rlib.buffer import SubBuffer
from rpython.rlib.rstring import strip_spaces
from rpython.rlib.rawstorage import RAW_STORAGE_PTR
from rpython.rtyper.lltypesystem import lltype, rffi

from clayPy.module.micronumpy import descriptor, loop, support
from clayPy.module.micronumpy.base import (wrap_impl,
    W_NDimArray, convert_to_array, W_NumpyObject)
from clayPy.module.micronumpy.converters import shape_converter, order_converter
...
def _array(space, w_object, w_dtype=None, copy=True, w_order=None, subok=False):
    ...
    from clayPy.module.micronumpy.boxes import W_GenericBox
