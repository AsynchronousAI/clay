...
from clayPy.module.micronumpy import types, boxes, support, constants as NPY
from .base import W_NDimArray
from clayPy.module.micronumpy.appbridge import get_appbridge_cache
from clayPy.module.micronumpy.converters import byteorder_converter
from clayPy.module.micronumpy.hashdescr import _array_descr_walk
...
def as_dtype(space, w_arg, allow_None=True):
    from clayPy.module.micronumpy.casting import scalar2dtype
