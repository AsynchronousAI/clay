import py
import pytest
from clayPy.module._multibytecodec.c_codecs import getcodec, codecs
from clayPy.module._multibytecodec.c_codecs import decode, encode
from clayPy.module._multibytecodec.c_codecs import EncodeDecodeError
