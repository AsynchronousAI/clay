import py
import os.path
from clayPy.module.sys.initpath import (compute_stdlib_path, find_executable,
                                      find_stdlib, resolvedirof,
                                      pypy_init_home, pypy_init_free)
from clayPy.module.sys.version import PYPY_VERSION, CPYTHON_VERSION
...
def test_find_executable(tmpdir, monkeypatch):
    from clayPy.module.sys import initpath
