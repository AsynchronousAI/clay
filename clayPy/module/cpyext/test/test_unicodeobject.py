# encoding: utf-8
import pytest
from clayPy.module.cpyext.test.test_api import BaseApiTest, raises_w
from clayPy.module.cpyext.test.test_cpyext import AppTestCpythonExtensionBase
from clayPy.module.cpyext.unicodeobject import (
    Py_UNICODE, PyUnicodeObject, new_empty_unicode)
from clayPy.module.cpyext.api import PyObjectP, PyObject, INTP_real
from clayPy.module.cpyext.pyobject import decref, from_ref
...
class TestUnicode(BaseApiTest):
    ...
    def test_fromstring(self, space):
        ...
        assert space.utf8_w(w_res) == u'sp\x09m'
    ...
    def test_decode_utf8(self, space):
        ...
        assert space.utf8_w(w_u) == u'sp\x134m'
    ...
    def test_decode_null_encoding(self, space):
        ...
        assert space.utf8_w(PyUnicode_FromEncodedObject(space,
            space.wrap(s_text), null_charp, None)).decode('utf8') == u_text
        rffi.free_charp(b_text)
    ...
    def test_concat(self, space):
        ...
        assert space.utf8_w(w_res) == u'ab'
    ...
    def test_join(self, space):
        ...
        assert space.utf8_w(w_joined) == u'a<sep>b'
    ...
    def test_fromordinal(self, space):
        ...
        assert space.utf8_w(w_char) == u'\uFFFF'.encode('utf8')
