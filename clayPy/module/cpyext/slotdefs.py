...
from clayPy.module.cpyext.pyobject import make_ref, from_ref, as_pyobj, decref
from clayPy.module.cpyext.pyerrors import PyErr_Occurred
from clayPy.module.cpyext.memoryobject import fill_Py_buffer
from clayPy.module.cpyext.state import State
from clayPy.module.cpyext import userslot
from clayPy.module.cpyext.buffer import CBuffer, CPyBuffer, fq
from clayPy.module.cpyext.methodobject import (W_PyCWrapperObject, tuple_from_args_w,
                                             w_kwargs_from_args)
...
class wrap_next(W_PyCWrapperObject):
    def call(self, space, w_self, __args__):
        from clayPy.module.cpyext.api import generic_cpy_call_expect_null
        self.check_args(__args__, 0)
        func = self.get_func_to_call()
