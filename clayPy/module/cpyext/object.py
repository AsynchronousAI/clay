...
from clayPy.module.cpyext.pyerrors import PyErr_NoMemory, PyErr_BadInternalCall
...
import clayPy.module.__builtin__.operation as operation
...
def PyObject_GenericSetAttr(space, w_obj, w_name, w_value):
    ...
    from clayPy.objspace.descroperation import object_setattr, object_delattr
...
def PyObject_IsInstance(space, w_inst, w_cls):
    ...
    of this function."""
    from clayPy.module.__builtin__.abstractinst import abstract_isinstance_w
