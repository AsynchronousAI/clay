...
from clayPy.module.cpyext.api import (cpython_api, CANNOT_FAIL, Py_ssize_t,
                                    build_type_checkers_flags)
from clayPy.module.cpyext.pyerrors import PyErr_BadInternalCall
from clayPy.module.cpyext.pyobject import decref, incref, PyObject, make_ref
...
def get_list_storage(space, w_list):
    from clayPy.module.cpyext.sequence import CPyListStrategy
    w_list.convert_to_cpy_strategy(space)
