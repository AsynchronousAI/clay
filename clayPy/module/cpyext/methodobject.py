...
from clayPy.interpreter.function import ClassMethod, Method, StaticMethod
...
from clayPy.module.cpyext.tupleobject import tuple_from_args_w
...
def PyCFunction_Check(space, w_obj):
    from clayPy.interpreter.function import BuiltinFunction
    if w_obj is None:
        return False
