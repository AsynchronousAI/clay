...
from clayPy.module.cpyext.api import cpython_api, cpython_struct, \
        METH_STATIC, METH_CLASS, METH_COEXIST, CANNOT_FAIL, CONST_STRING, \
        METH_NOARGS, METH_O, METH_VARARGS, build_type_checkers
from clayPy.module.cpyext.pyobject import PyObject, as_pyobj
from clayPy.interpreter.module import Module
from clayPy.module.cpyext.methodobject import (
    W_PyCFunctionObject, PyCFunction_NewEx, PyDescr_NewMethod,
    PyMethodDef, PyDescr_NewClassMethod, PyStaticMethod_New)
from clayPy.module.cpyext.pyerrors import PyErr_BadInternalCall
