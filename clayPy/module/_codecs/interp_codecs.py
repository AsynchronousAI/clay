...
def utf_16_ex_decode(space, data, errors='strict', byteorder=0, w_final=None):
    from clayPy.interpreter.unicodehelper import str_decode_utf_16_helper
...
def utf_32_ex_decode(space, data, errors='strict', byteorder=0, w_final=None):
    from clayPy.interpreter.unicodehelper import str_decode_utf_32_helper
...
def escape_encode(space, data, errors='strict'):
    from clayPy.objspace.std.bytesobject import string_escape_encode
...
def escape_decode(space, data, errors='strict'):
    from clayPy.interpreter.pyparser.parsestring import PyString_DecodeEscape
