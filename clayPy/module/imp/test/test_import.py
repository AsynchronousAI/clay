...
import clayPy.interpreter.pycode
from rpython.tool.udir import udir
from rpython.rlib import streamio
from clayPy.tool.option import make_config
from clayPy.tool.pytest.objspace import maketestobjspace
import pytest
import sys, os
import tempfile, marshal

from clayPy.module.imp import importing

from clayPy import conftest
...
class TestPycStuff:
    ...
    def test_read_compiled_module(self):
        ...
        try:
            ...
            stream.close()
        assert type(pycode) is clayPy.interpreter.pycode.PyCode
        w_dic = space.newdict()
...
def test_PYTHONPATH_takes_precedence(space):
    ...
    from clayPy.interpreter.test.test_zpy import pypypath
