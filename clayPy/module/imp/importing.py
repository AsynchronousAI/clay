...
from clayPy.interpreter.typedef import TypeDef, generic_new_descr
from clayPy.interpreter.error import OperationError, oefmt, wrap_oserror
from clayPy.interpreter.baseobjspace import W_Root, CannotHaveLock
from clayPy.interpreter.eval import Code
from clayPy.interpreter.pycode import PyCode
from clayPy.interpreter.streamutil import wrap_streamerror
...
def load_c_extension(space, filename, modulename):
    from clayPy.module.cpyext.api import load_extension_module
