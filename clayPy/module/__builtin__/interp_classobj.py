...
from clayPy.interpreter.executioncontext import report_error
...
from clayPy.interpreter.typedef import GetSetProperty, descr_get_dict, descr_set_dict
...
class Cache:
    def __init__(self, space):
        from clayPy.interpreter.typedef import _getusercls
