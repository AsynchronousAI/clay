...
from clayPy.objspace.std.iterobject import W_SeqIterObject, W_ReverseSeqIterObject
...
def xrangeiter_new(space, current, remaining, step):
    from clayPy.module.__builtin__.functional import W_XRangeIterator
...
def builtin_function(space, identifier):
    from clayPy.interpreter import function
    try:
...
def enumerate_new(space, w_iter, w_index):
    from clayPy.module.__builtin__.functional import _make_enumerate
    return _make_enumerate(space, w_iter, w_index)

def reversed_new(space, w_seq, w_remaining):
    from clayPy.module.__builtin__.functional import _make_reversed
