...
import clayPy.interpreter.pyopcode   # for side-effects
from clayPy.interpreter.error import OperationError, oefmt
from clayPy.interpreter.pycode import CO_GENERATOR, PyCode
from clayPy.interpreter.gateway import unwrap_spec
from clayPy.interpreter.pyframe import PyFrame
from clayPy.interpreter.pyopcode import ExitFrame, Yield
...
def get_printable_location(next_instr, is_being_profiled, bytecode):
    from clayPy.tool.stdlib_opcode import opcode_method_names
