import __builtin__
from clayPy.interpreter import special
from clayPy.interpreter.baseobjspace import ObjSpace, W_Root
from clayPy.interpreter.error import OperationError, oefmt
from clayPy.interpreter.typedef import get_unique_interplevel_subclass
from clayPy.objspace.descroperation import DescrOperation, raiseattrerror
from clayPy.objspace.std import frame, transparent, callmethod
...
# Object imports
from clayPy.objspace.std.basestringtype import basestring_typedef
from clayPy.objspace.std.boolobject import W_BoolObject
from clayPy.objspace.std.bufferobject import W_Buffer
from clayPy.objspace.std.bytearrayobject import W_BytearrayObject
from clayPy.objspace.std.bytesobject import W_BytesObject
from clayPy.objspace.std.complexobject import W_ComplexObject
from clayPy.objspace.std.dictmultiobject import W_DictMultiObject, W_DictObject
from clayPy.objspace.std.floatobject import W_FloatObject
from clayPy.objspace.std.intobject import W_IntObject, setup_prebuilt, wrapint
from clayPy.objspace.std.iterobject import W_AbstractSeqIterObject, W_SeqIterObject
from clayPy.objspace.std.iterobject import W_FastUnicodeIterObject
from clayPy.objspace.std.listobject import W_ListObject
from clayPy.objspace.std.longobject import W_LongObject, newlong
from clayPy.objspace.std.memoryobject import W_MemoryView
from clayPy.objspace.std.noneobject import W_NoneObject
from clayPy.objspace.std.objectobject import W_ObjectObject
from clayPy.objspace.std.setobject import W_SetObject, W_FrozensetObject
from clayPy.objspace.std.sliceobject import W_SliceObject
from clayPy.objspace.std.tupleobject import W_AbstractTupleObject, W_TupleObject
from clayPy.objspace.std.typeobject import W_TypeObject, TypeCache
from clayPy.objspace.std.unicodeobject import W_UnicodeObject
...
class StdObjSpace(ObjSpace):
    ...
    def initialize(self):
        ...
        from clayPy.objspace.std import dictproxyobject
    ...
    def get_objects_in_repr(self):
        from clayPy.module.__pypy__.interp_identitydict import W_IdentityDict
    ...
    def wraplong(self, x):
        if self.config.objspace.std.withsmalllong:
            ...
            try:
                ...
                from clayPy.objspace.std.smalllongobject import \
                                               W_SmallLongObject
    ...
    def newint(self, intval):
        if self.config.objspace.std.withsmalllong and isinstance(intval, base_int):
            from clayPy.objspace.std.smalllongobject import W_SmallLongObject
    ...
    def unpackcomplex(self, w_complex):
        from clayPy.objspace.std.complexobject import unpackcomplex
    ...
    def newtuple(self, list_w):
        from clayPy.objspace.std.tupleobject import wraptuple
        assert isinstance(list_w, list)
        make_sure_not_resized(list_w)
        return wraptuple(self, list_w)

    def newtuple2(self, w_a, w_b):
        from clayPy.objspace.std.tupleobject import wraptuple2
    ...
    def _uni_uses_no_iter(self, w_obj):
        from clayPy.objspace.descroperation import unicode_getitem
        return (self.lookup(w_obj, '__iter__') is None and
    ...
    def unicode_from_object(self, w_obj):
        from clayPy.objspace.std.unicodeobject import unicode_from_object
        return unicode_from_object(self, w_obj)

    def encode_unicode_object(self, w_unicode, encoding, errors):
        from clayPy.objspace.std.unicodeobject import encode_object
