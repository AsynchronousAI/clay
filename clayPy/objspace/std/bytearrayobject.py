...
from clayPy.objspace.std.sliceobject import W_SliceObject, unwrap_start_stop
from clayPy.objspace.std.stringmethods import StringMethods, _get_buffer
from clayPy.objspace.std.stringmethods import _descr_getslice_slowpath
from clayPy.objspace.std.bytesobject import W_BytesObject
from clayPy.objspace.std.util import get_positive_index
...
class W_BytearrayObject(W_Root):
    ...
    def descr_reduce(self, space):
        from clayPy.interpreter.unicodehelper import str_decode_latin_1
