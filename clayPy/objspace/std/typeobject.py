import weakref
from clayPy.interpreter import gateway
from clayPy.interpreter.baseobjspace import W_Root, SpaceCache
from clayPy.interpreter.error import OperationError, oefmt
from clayPy.interpreter.function import Function, StaticMethod
from clayPy.interpreter.typedef import (
    weakref_descr, GetSetProperty, dict_descr, Member, TypeDef)
from clayPy.interpreter.astcompiler.misc import mangle
from clayPy.module.__builtin__ import abstractinst
...
class W_TypeObject(W_Root):
    ...
    def __init__(self, space, name, bases_w, dict_w,
        ...
        from clayPy.objspace.std.mapdict import DictTerminator, NoDictTerminator
    ...
    def getattribute_if_not_from_object(self):
        ...
        from clayPy.objspace.descroperation import object_getattribute
    ...
    def compares_by_identity(self):
        from clayPy.objspace.descroperation import object_hash, type_eq
        #
...
#        print "miss", self, name
    ...
    def getdict(self, space):
        from clayPy.objspace.std.classdict import ClassDictStrategy
        from clayPy.objspace.std.dictmultiobject import W_DictObject
        if self.lazyloaders:
            self._cleanup_()    # force un-lazification
    ...
    def hack_which_new_to_call(self, w_newtype, w_newdescr):
        ...
        #
        from clayPy.module.cpyext.methodobject import W_PyCFunctionObject
    ...
    def _really_hack_which_new_to_call(self, w_newtype, w_newdescr):
        ...
        from clayPy.module.cpyext.methodobject import W_PyCFunctionObject
        from clayPy.module.cpyext.typeobject import is_tp_new_wrapper
...
def type_get_dict(space, w_cls):
    ...
    from clayPy.objspace.std.dictproxyobject import W_DictProxyObject
...
def create_all_slots(w_self, hasoldstylebase, w_bestbase, force_new_layout):
    from clayPy.interpreter.miscutils import string_sort
...
class TypeCache(SpaceCache):
    ...
    def build(self, typedef):
        ...
        from clayPy.interpreter.typedef import GetSetProperty
