...
from clayPy.objspace.std.util import negate
...
class W_DictMultiObject(W_Root):
    ...
    def allocate_and_init_instance(space, w_type=None, module=False,
                                   ...
                                   kwargs=False):
        if module:
            from clayPy.objspace.std.celldict import ModuleDictStrategy
            ...
            from clayPy.objspace.std.mapdict import make_instance_dict
            assert w_type is None
            ...
            assert w_type is None
            from clayPy.objspace.std.kwargsdict import EmptyKwargsDictStrategy
...
class EmptyDictStrategy(DictStrategy):
    ...
    def switch_to_identity_strategy(self, w_dict):
        from clayPy.objspace.std.identitydict import IdentityDictStrategy
