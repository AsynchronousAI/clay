...
import token
import StringIO
from clayPy.interpreter.pyparser.metaparser import ParserGenerator, PgenError
from clayPy.interpreter.pyparser.pygram import PythonGrammar
...
class TestParserGenerator:
    ...
    def test_optional_repeater(self):
        ...
        arcs1, is_accepting1 = g.dfas[0].states[1]
        arcs2, is_accepting2 = g.dfas[0].states[2]
        assert not (is_accepting1 and is_accepting2)
