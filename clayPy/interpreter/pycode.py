...
from clayPy.interpreter import eval
...
from clayPy.interpreter.astcompiler.consts import (
    CO_OPTIMIZED, CO_NEWLOCALS, CO_VARARGS, CO_VARKEYWORDS, CO_NESTED,
    CO_GENERATOR, CO_KILL_DOCSTRING, CO_YIELD_INSIDE_TRY)
from clayPy.tool.stdlib_opcode import opcodedesc, HAVE_ARGUMENT
...
class PyCode(eval.Code):
    ...
    def _initialize(self):
        from clayPy.objspace.std.mapdict import init_mapdict_cache
        from clayPy.interpreter.nestedscope import CellFamily
        if self.co_cellvars:
