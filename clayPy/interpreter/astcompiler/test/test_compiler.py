import py, sys
from clayPy.interpreter.astcompiler import codegen, astbuilder, symtable, optimize
from clayPy.interpreter.pyparser import pyparse
from clayPy.interpreter.pyparser.test import expressions
from clayPy.interpreter.pycode import PyCode
from clayPy.interpreter.pyparser.error import SyntaxError, IndentationError
from clayPy.tool import stdlib_opcode as ops
...
class TestCompilerRevDB(BaseTestCompiler):
    ...
    def test_revdb_metavar(self):
        from clayPy.interpreter.reverse_debugging import dbstate, setup_revdb
