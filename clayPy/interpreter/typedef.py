...
from clayPy.interpreter.gateway import (interp2app, BuiltinCode, unwrap_spec,
     WrappedDefault)
...
def _getusercls(cls, reallywantdict=False):
    ...
    from clayPy.objspace.std.mapdict import (BaseUserClassMapdict,
...
from clayPy.interpreter.eval import Code
from clayPy.interpreter.pycode import PyCode, CO_VARARGS, CO_VARKEYWORDS
from clayPy.interpreter.pyframe import PyFrame
from clayPy.interpreter.pyopcode import SuspendedUnroller
from clayPy.interpreter.module import Module
from clayPy.interpreter.function import (Function, Method, StaticMethod,
...
from clayPy.interpreter.special import NotImplemented, Ellipsis
