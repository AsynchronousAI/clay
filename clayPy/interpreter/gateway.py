...
from clayPy.interpreter.baseobjspace import (W_Root, ObjSpace, SpaceCache,
    DescrMismatch)
from clayPy.interpreter.error import OperationError, oefmt
from clayPy.interpreter.function import ClassMethod, FunctionWithFixedCode
...
class GatewayCache(SpaceCache):
    ...
    def build(cache, gateway):
        ...
        #
        from clayPy.module.sys.vm import exc_info
