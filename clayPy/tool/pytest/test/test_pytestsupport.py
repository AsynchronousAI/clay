...
from clayPy.interpreter.gateway import app2interp_temp
from clayPy.interpreter.argument import Arguments
from clayPy.interpreter.pycode import PyCode
from clayPy.tool.pytest.appsupport import (AppFrame, build_pytest_assertion,
...
import sys
import clayPy
conftestpath = py.path.local(clayPy.__file__).dirpath("conftest.py")
