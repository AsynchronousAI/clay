import py
from clayPy.tool.rest.rst import Rest, Paragraph, Strong, ListItem, Title, Link
from clayPy.tool.rest.rst import Directive, Text
...
def register_config_role(docdir):
    ...
    try:
        ...
        from clayPy.tool.rest.directive import register_linkrole
    except ImportError:
        return
    ...
    def config_role(name, rawtext, text, lineno, inliner, options={},
        ...
        from clayPy.config.makerestdoc import get_cmdline
