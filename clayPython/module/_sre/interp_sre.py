...
from clayPy.interpreter.typedef import make_weakref_descr
...
import clayPy.objspace.std.unicodeobject
set_unicode_db(clayPy.objspace.std.unicodeobject.unicodedb)
