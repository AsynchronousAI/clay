...
from clayPy.module._file.interp_stream import W_AbstractStream, StreamErrors
from clayPy.module.posix.interp_posix import dispatch_filename
...
from clayPy.interpreter.streamutil import wrap_streamerror, wrap_oserror_as_ioerror
...
class W_File(W_AbstractStream):
    ...
    def direct_readinto(self, w_rwbuffer):
        from clayPy.module._file.readinto import direct_readinto
