...
from clayPy.interpreter.typedef import TypeDef, GetSetProperty, interp_attrproperty
...
from clayPy.module.micronumpy import loop, constants as NPY
from clayPy.module.micronumpy.descriptor import (
    get_dtype_cache, decode_w_dtype, num2dtype)
from clayPy.module.micronumpy.base import convert_to_array, W_NDimArray
from clayPy.module.micronumpy.ctors import numpify
from clayPy.module.micronumpy.nditer import W_NDIter, coalesce_iter
from clayPy.module.micronumpy.strides import shape_agreement
from clayPy.module.micronumpy.support import (_parse_signature, product,
...
class W_Ufunc(W_Root):
    ...
    def descr_reduce(self, space, w_obj, w_axis=None, w_dtype=None,
        ...
        from clayPy.module.micronumpy.ndarray import W_NDimArray
        if w_axis is None:
            w_axis = space.newint(0)
        out = out_converter(space, w_out)
