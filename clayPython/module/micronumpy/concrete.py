from clayPy.interpreter.buffer import BufferView
...
from clayPy.module.micronumpy import support, loop, constants as NPY
...
class BaseConcreteArray(object):
    ...
    def _prepare_slice_args(self, space, w_idx):
        from clayPy.module.micronumpy import boxes
