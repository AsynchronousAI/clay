...
from clayPy.module.exceptions.interp_exceptions import W_IOError
from clayPy.module._io.interp_fileio import W_FileIO
from clayPy.module._io.interp_textio import W_TextIOWrapper
...
def open(space, w_file, mode="r", buffering=-1, encoding=None, errors=None,
    ...
    from clayPy.module._io.interp_bufferedio import (W_BufferedRandom,
