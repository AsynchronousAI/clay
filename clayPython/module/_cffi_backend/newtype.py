...
from clayPy.module._cffi_backend.moduledef import FFI_DEFAULT_ABI
from clayPy.module._cffi_backend import (ctypeobj, ctypeprim, ctypeptr,
...
def _clean_cache(space):
    "NOT_RPYTHON"
    from clayPy.module._cffi_backend.realize_c_type import RealizeCache
    from clayPy.module._cffi_backend.call_python import KeepaliveCache
...
def detect_custom_layout(w_ctype, sflags, cdef_value, compiler_value,
    ...
    if compiler_value != cdef_value:
        if sflags & SF_STD_FIELD_POS:
            from clayPy.module._cffi_backend.ffi_obj import get_ffi_error
