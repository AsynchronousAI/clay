...
from clayPy.interpreter.typedef import TypeDef, GetSetProperty, ClassAttr
from clayPy.interpreter.gateway import interp2app, unwrap_spec, WrappedDefault
from rpython.rlib import jit, rgc
from rpython.rtyper.lltypesystem import lltype, rffi

from clayPy.module._cffi_backend.moduledef import get_dict_rtld_constants
from clayPy.module._cffi_backend import parse_c_type, realize_c_type
from clayPy.module._cffi_backend import newtype, cerrno, ccallback, ctypearray
from clayPy.module._cffi_backend import ctypestruct, ctypeptr, handle
from clayPy.module._cffi_backend import cbuffer, func, wrapper, call_python
from clayPy.module._cffi_backend import cffi_opcode, allocator
from clayPy.module._cffi_backend.ctypeobj import W_CType
from clayPy.module._cffi_backend.cdataobj import W_CData
...
class W_FFIObject(W_Root):
    ...
    def descr_init(self, module_name='?', _version=-1, _types='',
        ...
        from clayPy.module._cffi_backend import cdlopen
        #
        space = self.space
        if self.is_nonempty:
...
function or global variable."""
        #
        from clayPy.module._cffi_backend.lib_obj import W_LibObject
        space = self.space
