...
from clayPy.module._cffi_backend import parse_c_type
from clayPy.module._cffi_backend import cerrno
from clayPy.module._cffi_backend import cffi_opcode
from clayPy.module._cffi_backend import realize_c_type
...
def _cffi_call_python(ll_externpy, ll_args):
    ...
    """
    from clayPy.module._cffi_backend.ccallback import reveal_callback
...
def externpy_deco(space, w_ffi, w_python_callable, w_name, w_error, w_onerror):
    from clayPy.module._cffi_backend.ffi_obj import W_FFIObject
    from clayPy.module._cffi_backend.ccallback import W_ExternPython
