...
from clayPy.module._cffi_backend import ctypeobj, cdataobj, allocator
...
def callback(space, w_ctype, w_callable, w_error=None, w_onerror=None):
    from clayPy.module._cffi_backend.ccallback import make_callback
...
def _get_common_types(space, w_dict):
    from clayPy.module._cffi_backend.parse_c_type import ll_enum_common_types
    index = 0
    while True:
