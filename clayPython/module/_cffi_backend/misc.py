...
from clayPy.module._rawffi.interp_rawffi import wrap_dlopenerror
...
def _is_a_float(space, w_ob):
    ...
    from clayPy.module._cffi_backend.ctypeprim import W_CTypePrimitiveFloat
...
def object_as_bool(space, w_ob):
    ...
    from clayPy.module._cffi_backend.cdataobj import W_CData
    from clayPy.module._cffi_backend.ctypeprim import W_CTypePrimitiveFloat
    from clayPy.module._cffi_backend.ctypeprim import W_CTypePrimitiveLongDouble
...
def dlopen_w(space, w_filename, flags):
    from clayPy.module._cffi_backend.cdataobj import W_CData
    from clayPy.module._cffi_backend import ctypeptr
