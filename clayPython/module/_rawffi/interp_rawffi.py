...
from clayPy.interpreter.error import OperationError, oefmt, wrap_oserror
from clayPy.interpreter.gateway import interp2app, unwrap_spec
from clayPy.interpreter.typedef import interp_attrproperty
from clayPy.interpreter.typedef import TypeDef, GetSetProperty
from clayPy.interpreter.unicodehelper import wcharpsize2utf8
from clayPy.interpreter.unicodehelper import wrap_unicode_out_of_range_error
...
from clayPy.module._rawffi.buffer import RawFFIBuffer
from clayPy.module._rawffi.tracker import tracker
...
def letter2tp(space, key):
    from clayPy.module._rawffi.interp_array import PRIMITIVE_ARRAY_TYPES
    try:
...
def unpack_simple_shape(space, w_shape):
    ...
    if space.isinstance_w(w_shape, space.w_text):
        ...
        from clayPy.module._rawffi.structure import W_Structure
...
def unpack_shape_with_length(space, w_shape):
    ...
    if space.isinstance_w(w_shape, space.w_text):
        ...
        try:
            ...
            from clayPy.module._rawffi.interp_array import W_Array
...
class W_DataShape(W_Root):
    ...
    def descr_get_ffi_type(self, space):
        from clayPy.module._rawffi.alt.interp_ffitype import W_FFIType
...
class W_DataInstance(W_Root):
    ...
    def byptr(self, space):
        from clayPy.module._rawffi.interp_array import ARRAY_OF_PTRS
...
class W_FuncPtr(W_Root):
    ...
    def call(self, space, args_w):
        from clayPy.module._rawffi.interp_array import W_ArrayInstance
        from clayPy.module._rawffi.structure import W_StructureInstance
        from clayPy.module._rawffi.structure import W_Structure
        argnum = len(args_w)
