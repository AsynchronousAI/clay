from clayPy.interpreter.error import oefmt, wrap_oserror
from clayPy.interpreter.gateway import unwrap_spec
from clayPy.interpreter.pycode import CodeHookCache
...
from clayPy.objspace.std.setobject import W_BaseSetObject
from clayPy.objspace.std.typeobject import MethodCache
from clayPy.objspace.std.mapdict import MapAttrCache
...
def builtinify(space, w_func):
    ...
    """
    from clayPy.interpreter.function import Function, BuiltinFunction
...
def specialized_zip_2_lists(space, w_list1, w_list2):
    from clayPy.objspace.std.specialisedtupleobject import specialized_zip_2_lists
...
def revdb_stop(space):
    from clayPy.interpreter.reverse_debugging import stop_point
    stop_point()
...
def pyos_inputhook(space):
    ...
    from clayPy.module.cpyext.api import invoke_pyos_inputhook
