...
from clayPy.module.cpyext.pyerrors import PyErr_SetFromErrno
from clayPy.module.cpyext.funcobject import PyCodeObject
from clayPy.module.cpyext.frameobject import PyFrameObject
from clayPy.module.__builtin__ import compiling
...
def Py_GetRecursionLimit(space):
    from clayPy.module.sys.vm import getrecursionlimit
...
def Py_SetRecursionLimit(space, limit):
    from clayPy.module.sys.vm import setrecursionlimit
