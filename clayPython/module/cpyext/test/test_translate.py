...
import clayPy.module.cpyext.api
from clayPy.module.cpyext.api import slot_function
...
def test_llhelper(monkeypatch):
    ...
    def make_wrapper(self, space):
        ...
        return wrapper
    monkeypatch.setattr(clayPy.module.cpyext.api.ApiFunction, '_make_wrapper', make_wrapper)
