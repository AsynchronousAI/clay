...
from clayPy.module.cpyext.object import PyObject_Size, PyObject_GetItem
from clayPy.module.cpyext.pythonrun import Py_AtExit
from clayPy.module.cpyext.eval import (
