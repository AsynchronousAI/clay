...
from clayPy.module.cpyext.api import CANNOT_FAIL, cpython_api, build_type_checkers
...
from clayPy.module.__builtin__.interp_classobj import W_ClassObject, W_InstanceObject
