...
from clayPy.interpreter.baseobjspace import W_Root, DescrMismatch
from clayPy.interpreter.error import oefmt
from clayPy.interpreter.typedef import (
    GetSetProperty, TypeDef, interp_attrproperty, interp2app)
from clayPy.module.__builtin__.abstractinst import abstract_issubclass_w
from clayPy.module.cpyext import structmemberdefs
...
from clayPy.module.cpyext.methodobject import (W_PyCClassMethodObject,
    PyCFunction_NewEx, PyCFunction, PyMethodDef,
    W_PyCMethodObject, W_PyCFunctionObject, W_PyCWrapperObject)
from clayPy.module.cpyext.modsupport import convert_method_defs
...
from clayPy.module.cpyext.slotdefs import (
    slotdefs_for_tp_slots, slotdefs_for_wrappers, get_slot_tp_function,
    llslot)
from clayPy.module.cpyext.state import State
from clayPy.module.cpyext.structmember import PyMember_GetOne, PyMember_SetOne
from clayPy.module.cpyext.typeobjectdefs import (
...
def add_operators(space, dict_w, pto):
    from clayPy.module.cpyext.object import PyObject_HashNotImplemented
...
def _str_getreadbuffer(space, w_str, segment, ref):
    from clayPy.module.cpyext.bytesobject import PyString_AsString
    if segment != 0:
        raise oefmt(space.w_SystemError,
...
def unicode_getreadbuffer(space, w_str, segment, ref):
    from clayPy.module.cpyext.unicodeobject import (
...
def buf_getreadbuffer(space, pyref, segment, ref):
    from clayPy.module.cpyext.bufferobject import PyBufferObject
    if segment != 0:
        raise oefmt(space.w_SystemError,
...
def finish_type_2(space, pto, w_obj):
    ...
    if not pto.c_tp_setattro:
        from clayPy.module.cpyext.object import PyObject_GenericSetAttr
        pto.c_tp_setattro = llslot(space, PyObject_GenericSetAttr)

    if not pto.c_tp_getattro:
        from clayPy.module.cpyext.object import PyObject_GenericGetAttr
