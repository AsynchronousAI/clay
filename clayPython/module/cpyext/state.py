...
from clayPy.interpreter import executioncontext
...
class State:
    ...
    def reset(self):
        from clayPy.module.cpyext.modsupport import PyMethodDef
    ...
    def setup_rawrefcount(self):
        ...
        if not self.space.config.translating:
            def dealloc_trigger():
                from clayPy.module.cpyext.pyobject import PyObject, decref
    ...
    def startup(self, space):
        ...
        from clayPy.module.cpyext.typeobject import setup_new_method_def
        from clayPy.module.cpyext.api import INIT_FUNCTIONS
    ...
    def find_extension(self, name, path):
        from clayPy.module.cpyext.modsupport import PyImport_AddModule
