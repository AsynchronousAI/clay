...
from clayPy.interpreter import pycode, pytraceback
from clayPy.interpreter.argument import Arguments
from clayPy.interpreter.astcompiler import consts
from clayPy.interpreter.baseobjspace import W_Root
from clayPy.interpreter.error import (
    OperationError, get_cleared_operation_error, oefmt)
from clayPy.interpreter.executioncontext import ExecutionContext
from clayPy.interpreter.nestedscope import Cell
from clayPy.tool import stdlib_opcode
...
class PyFrame(W_Root):
    ...
    def _reduce_state(self, space):
        from clayPy.module._pickle_support import maker # helper fns
        nt = space.newtuple
    ...
    def fset_f_lineno(self, space, w_new_lineno):
        ...
        from clayPy.interpreter.pyopcode import FinallyBlock
    ...
    def _convert_unexpected_exception(self, e):
        from clayPy.interpreter import error
...
def get_block_class(opname):
    ...
    from clayPy.interpreter.pyopcode import block_classes
