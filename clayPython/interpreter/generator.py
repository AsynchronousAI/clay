...
from clayPy.interpreter.pyopcode import LoopBlock
from clayPy.interpreter.pycode import CO_YIELD_INSIDE_TRY
from clayPy.interpreter.typedef import TypeDef, make_weakref_descr, interp_attrproperty, GetSetProperty
...
return next yielded value or raise StopIteration."""
    ...
    def throw(self, w_type, w_val, w_tb):
        from clayPy.interpreter.pytraceback import check_traceback
        space = self.space
...
from clayPy.tool.stdlib_opcode import HAVE_ARGUMENT, opmap
