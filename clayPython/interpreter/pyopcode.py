...
from clayPy.interpreter import (
...
from clayPy.interpreter.pycode import PyCode, BytecodeCorruption
from clayPy.tool.stdlib_opcode import bytecode_spec
...
class __extend__(pyframe.PyFrame):
    ...
    def STORE_GLOBAL(self, nameindex, next_instr):
        ...
        from clayPy.objspace.std.celldict import STORE_GLOBAL_cached
    ...
    def LOAD_GLOBAL(self, nameindex, next_instr):
        ...
        #return
        from clayPy.objspace.std.celldict import LOAD_GLOBAL_cached
    ...
    def LOAD_ATTR(self, nameindex, next_instr):
        ...
        if not jit.we_are_jitted():
            from clayPy.objspace.std.mapdict import LOAD_ATTR_caching
    ...
    def _revdb_jump_backward(self, jumpto):
        ...
        from clayPy.interpreter.reverse_debugging import jump_backward
    ...
    def _revdb_load_var(self, oparg):
        # moved in its own function for the import statement
        from clayPy.interpreter.reverse_debugging import load_metavar
