...
class Function(W_Root):
    ...
    def funccall_valuestack(self, nargs, frame, methodcall=False): # speed hack
        ...
        if (jit.we_are_jitted() and code is self.space._code_of_sys_exc_info
                                and nargs == 0):
            from clayPy.module.sys.vm import exc_info_direct
    ...
    def _cleanup_(self):
        # delicate
        from clayPy.interpreter.gateway import BuiltinCode
...
class Method(W_Root):
    ...
    def immutable_unique_id(self, space):
        ...
        #
        from clayPy.objspace.std.util import IDTAG_UNBOUND_METHOD as tag
