...
from clayPy.interpreter.buffer import BufferInterfaceNotFound
from clayPy.interpreter.executioncontext import (ExecutionContext, ActionFlag,
    make_finalizer_queue)
from clayPy.interpreter.error import OperationError, new_exception_class, oefmt
from clayPy.interpreter.argument import Arguments
from clayPy.interpreter.miscutils import ThreadLocals, make_weak_value_dictionary
...
class W_Root(object):
    ...
    def _cpyext_as_pyobj(self, space):
        from clayPy.module.cpyext.pyobject import w_root_as_pyobj
        return w_root_as_pyobj(self, space)

    def _cpyext_attach_pyobj(self, space, py_obj):
        from clayPy.module.cpyext.pyobject import w_root_attach_pyobj
...
class ObjSpace(object):
    ...
    def __init__(self, config=None):
        ...
        if config is None:
            from clayPy.config.pypyoption import get_pypy_config
    ...
    def make_builtins(self):
        ...
        from clayPy.module.exceptions.moduledef import Module
        w_name = self.newtext('exceptions')
        self.exceptions_module = Module(self, w_name)
        self.exceptions_module.install()

        from clayPy.module.imp.moduledef import Module
        w_name = self.newtext('imp')
        mod = Module(self, w_name)
        mod.install()

        from clayPy.module.sys.moduledef import Module
        w_name = self.newtext('sys')
        self.sys = Module(self, w_name)
        self.sys.install()

        from clayPy.module.__builtin__.moduledef import Module
    ...
    def setup_builtin_modules(self):
        ...
        if self.config.objspace.usemodules.cpyext:
            ...
            from clayPy.module._cffi_backend import copy_includes
            copy_includes.main()
    ...
    def createcompiler(self):
        ...
        try:
            ...
            from clayPy.interpreter.pycompiler import PythonAstCompiler
    ...
    def _revdb_startup(self):
        ...
        from clayPy.interpreter.reverse_debugging import setup_revdb
        setup_revdb(self)

    def _revdb_standard_code(self):
        # moved in its own function for the import statement
        from clayPy.interpreter.reverse_debugging import dbstate
    ...
    def newlist_hint(self, sizehint):
        from clayPy.objspace.std.listobject import make_empty_list_with_size
    ...
    def call_obj_args(self, w_callable, w_obj, args):
        if not self.config.objspace.disable_call_speedhacks:
            ...
            from clayPy.interpreter.function import Function
    ...
    def _try_fetch_pycode(self, w_func):
        from clayPy.interpreter.function import Function, Method
    ...
    def call_valuestack(self, w_func, nargs, frame, methodcall=False):
        ...
        from clayPy.interpreter.function import Function, Method, is_builtin_code
    ...
    def is_oldstyle_instance(self, w_obj):
        # xxx hack hack hack
        from clayPy.module.__builtin__.interp_classobj import W_InstanceObject
    ...
    def _cached_compile(self, filename, source, mode, flags, hidden_applevel, ast_transform=None):
        ...
        from clayPy.module.marshal import interp_marshal
        from clayPy.interpreter.pycode import default_magic
