...
from clayPy.interpreter.astcompiler import ast, assemble, symtable, consts, misc
from clayPy.interpreter.astcompiler import optimize # For side effects
        ...
        if op in (ast.In, ast.NotIn):
            ...
            if is_list or isinstance(node, ast.Set):
                ...
                if w_const is not None:
                    if not is_list:
                        from clayPy.objspace.std.setobject import (
                            W_FrozensetObject)
