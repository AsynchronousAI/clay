...
from clayPy.interpreter.astcompiler.astbuilder import ast_from_node
from clayPy.interpreter.astcompiler import ast, consts
...
class TestAstBuilder:
    ...
    def test_function(self):
        ...
        with pytest.raises(SyntaxError) as excinfo:
            self.get_ast(input)
        assert excinfo.value.msg == "parenthesized arg with default"
    ...
    def test_call(self):
        ...
        exc = pytest.raises(SyntaxError, self.get_ast, "f(x, *a, b)").value
