...
from clayPy.interpreter.pyparser.pylexer import *
from clayPy.interpreter.pyparser.automata import NonGreedyDFA, DFA, DEFAULT
from clayPy.interpreter.pyparser import pytoken
