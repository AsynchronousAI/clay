import pytest
from clayPy.objspace.std.test.test_dictmultiobject import FakeSpace, W_DictObject
from clayPy.objspace.std.mapdict import *
...
def test_special():
    from clayPy.module._weakref.interp__weakref import WeakrefLifeline
...
def test_no_int_unboxing(monkeypatch):
    from clayPy.objspace.std import mapdict
...
def test_unbox_reorder_bug3():
    from clayPy.objspace.std.mapdict import _make_storage_mixin_size_n
...
from clayPy.objspace.std.test.test_dictmultiobject import BaseTestRDictImplementation, BaseTestDevolvedDictImplementation
def get_impl(self):
    cls = Class()
...
def test_correct_method_sharing(space):
    from clayPy.objspace.std import bytesobject, objectobject, unicodeobject
