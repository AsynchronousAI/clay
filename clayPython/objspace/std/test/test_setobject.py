...
is not too wrong.
"""
from clayPy.objspace.std.setobject import W_SetObject, W_FrozensetObject, IntegerSetStrategy
from clayPy.objspace.std.setobject import _initialize_set
...
class TestW_SetObject:
    ...
    def test_create_set_from_list(self):
        ...
        from clayPy.objspace.std.setobject import BytesSetStrategy, ObjectSetStrategy
