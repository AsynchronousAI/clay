...
from clayPy.objspace.std import listobject
from clayPy.objspace.std.test.test_listobject import TestW_ListObject
...
class TestW_ListStrategies(TestW_ListObject):
    ...
    def test_create_list_from_set(self):
        from clayPy.objspace.std.setobject import W_SetObject
