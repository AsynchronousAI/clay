...
from clayPy.interpreter.gateway import applevel, interp2app, unwrap_spec
from clayPy.interpreter.typedef import (
    GetSetProperty, TypeDef, default_identity_hash)
from clayPy.objspace.descroperation import Object
...
def descr__new__(space, w_type, __args__):
    from clayPy.objspace.std.typeobject import _precheck_for_new
