...
from clayPy.interpreter import typedef
...
from clayPy.objspace.std.util import (
...
def _pow_ovf2long(space, iv, w_iv, iw, w_iw, w_modulus):
    if space.is_none(w_modulus) and _recover_with_smalllong(space):
        from clayPy.objspace.std.smalllongobject import _pow as _pow_small
        try:
            ...
            pass
    from clayPy.objspace.std.longobject import W_LongObject, W_AbstractLongObject
...
def _new_int(space, w_inttype, w_x, w_base=None):
    ...
    if w_base is None:
        ...
        if type(w_value) is W_IntObject:
            ...
            from clayPy.objspace.std.unicodeobject import unicode_to_decimal_w
