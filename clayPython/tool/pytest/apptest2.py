...
import clayPy.interpreter.function
from clayPy.tool.pytest import app_rewrite
from clayPy.interpreter.error import OperationError
from clayPy.interpreter.module import Module
from clayPy.tool.pytest import objspace
from clayPy.tool.pytest import appsupport
from clayPy.tool.pytest.astrewriter.ast_rewrite import rewrite_asserts_ast
    ...
    def collect(self):
        ...
        for name, w_obj in mod_dict.items():
            if not name.startswith('test_'):
                continue
            if not isinstance(w_obj, clayPy.interpreter.function.Function):
                continue
