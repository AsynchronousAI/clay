...
from clayPy.tool.ann_override import PyPyAnnotatorPolicy
from rpython.config.config import to_optparse, make_dict, SUPPRESS_USAGE
from rpython.config.config import ConflictConfigError
from clayPy.tool.option import make_objspace
from clayPy import pypydir
from rpython.rlib import rthread
from clayPy.module.thread import os_thread
...
def get_additional_entrypoints(space, w_initstdio):
    ...
    def pypy_setup_home(ll_home, verbose):
        from clayPy.module.sys.initpath import pypy_find_stdlib
...
class PyPyTarget(object):
    ...
    def handle_config(self, config, translateconfig):
        ...
        from clayPy.config.pypyoption import set_pypy_opt_level
    ...
    def get_additional_config_options(self):
        from clayPy.config.pypyoption import pypy_optiondescription
    ...
    def target(self, driver, args):
        ...
        if config.objspace.allworkingmodules:
            from clayPy.config.pypyoption import enable_allworkingmodules
            enable_allworkingmodules(config)
        if config.objspace.translationmodules:
            from clayPy.config.pypyoption import enable_translationmodules
        ...
        from clayPy.module.sys.moduledef import Module as SysModule
    ...
    def jitpolicy(self, driver):
        from clayPy.module.pypyjit.policy import PyPyJitPolicy
        from clayPy.module.pypyjit.hooks import pypy_hooks
        return PyPyJitPolicy(pypy_hooks)

    def get_gchooks(self):
        from clayPy.module.gc.hook import LowLevelGcHooks
