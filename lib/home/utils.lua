...
--
-- Dependencies: `lib.compat`, all exported fields and functions from
-- `lib.compat` are also available in this module.
--
-- @module lib.utils
...
-- Something that is callable, or an operator string as defined by <code>lib.operator</code>,
...
function utils.function_arg (idx,f,msg)
    ...
    if tp == 'string' then
        if not operators then operators = require 'lib.operator'.optable end
...
-- to `os.execute`, `lib.utils.execute` or `lib.utils.executeex`.
...
--     "-lluacov",
--     "-e",
--     "utils = print(require('lib.utils')._VERSION",
-- }
-- -- returns: -lluacov -e 'utils = print(require('\''lib.utils'\'')._VERSION'
