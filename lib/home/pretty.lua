...
--
-- Dependencies: `lib.utils`, `lib.lexer`, `lib.stringx`, `debug`
-- @module lib.pretty
...
local quote_string = require'lib.stringx'.quote_string
...
--
--     print(require("lib.pretty").write({...}))
--
-- Can be shortened to:
--
--     require"lib.pretty" (...)
...
-- require"lib.pretty" ("hello", nil, "world", { bye = "world", true} )
--
-- -- output:
-- {
--   ["arg 1"] = "hello",
