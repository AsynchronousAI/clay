...
-- that this implicitly brings in `lib.utils` as a dependency.
--
...
class = setmetatable({},{
    ...
    __index = function(tbl,key)
        if key == 'class' then
            io.stderr:write('require("lib.class").class is deprecated. Use require("lib.class")\n')
            return class
        end
        compat = compat or require 'lib.compat'
