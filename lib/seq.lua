...
--
-- Dependencies: `lib.utils`, `lib.types`, `debug`
-- @module lib.seq
...
local callable = require 'lib.types'.is_callable
...
function seq.copy(iter)
    ...
    setmetatable(res, require('lib.List'))
    return res
end
...
-- `lib.tablex.count_map` is more general.
-- @param iter a sequence
-- @return a map-like table
-- @return a table
-- @see lib.tablex.count_map
function seq.count_map(iter)
    ...
    return setmetatable(t, require('lib.Map'))
end
