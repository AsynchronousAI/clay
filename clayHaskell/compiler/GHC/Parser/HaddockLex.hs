...
{-# LANGUAGE CPP #-}
{-# LANGUAGE MagicHash #-}
{-# LINE 1 "_build/source-dist/ghc-9.4.3-src/ghc-9.4.3/compiler/GHC/Parser/HaddockLex.x" #-}
...
{-# LINE 87 "_build/source-dist/ghc-9.4.3-src/ghc-9.4.3/compiler/GHC/Parser/HaddockLex.x" #-}
